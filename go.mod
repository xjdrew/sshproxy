module github.com/xjdrew/sshproxy

go 1.25.5

require (
	go.containerssh.io/containerssh v0.5.2
	golang.org/x/crypto v0.46.0
	gopkg.in/yaml.v3 v3.0.1
)

// 使用 gigabyte132 的 persistent 模式分支 (PR #659)
replace go.containerssh.io/containerssh => github.com/gigabyte132/ContainerSSH v0.0.0-20250805131833-811d802510c9
